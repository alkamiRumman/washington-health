    ...
    return (
        <OfficerLayout breadcrumbs={[{ title: 'Officer Dashboard', href: '/officer/dashboard' }]}>
            ...
            <div className="flex h-full flex-1 flex-col gap-2 p-4 lg:p-6">
                ...
                <div className="mt-4 overflow-hidden rounded-xl border bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    <div className="flex items-center justify-between border-b px-6 py-4 dark:border-gray-700">
                        ...
                        <Link
                            ...
                            className="cursor-pointer text-sm text-indigo-600 hover:text-indigo-500 dark:text-indigo-400"
                        >
                            View all
                        </Link>
                    </div>
