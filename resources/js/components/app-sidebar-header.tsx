                    ...
                    <Popover>
                            ...
                            <div
                                className={cn(
                                    ...
                                    appearance === 'dark'
                                        ...
                                        : 'bg-gray-200 text-black hover:bg-neutral-200/60 dark:hover:bg-neutral-700/60',
                                )}
                            >
                                {appearance === 'dark' ? (
                                    <>
                                        <Moon className="h-4 w-4" />
                                        <span className="ml-1.5 hidden text-sm md:inline">Dark</span>
                                    </>
                                ) : appearance === 'light' ? (
                                    <>
                                        <Sun className="h-4 w-4" />
                                        <span className="ml-1.5 hidden text-sm md:inline">Light</span>
                                    </>
                                ) : (
                                    <>
                                        <Laptop2 className="h-4 w-4" />
                                        <span className="ml-1.5 hidden text-sm md:inline">System</span>
                                    </>
                                )}
                            </div>
                        </PopoverTrigger>
                        <PopoverContent className="w-40 space-y-1 p-2">
                            <button
                                ...
                                className={cn(
                                    'flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm hover:bg-neutral-100 dark:hover:bg-neutral-700',
